...
public class Weather extends Activity {
    ...
    private class AsyncGetUrl extends AsyncTask<Void, Void, Void> {
    	private final ProgressDialog dialog = new ProgressDialog(Weather.this);
		...
		protected void onPostExecute(final Void unused) {
	        lv1.setAdapter(new ArrayAdapter<String>(Weather.this,android.R.layout.simple_list_item_1 , weatherData));
	        this.dialog.dismiss();
		}
